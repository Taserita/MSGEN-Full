...
from utils.datasets import ConformationDataset, BackboneConformationDataset
...
if __name__ == '__main__':
    ...
    train_set = BackboneConformationDataset(config.dataset.train, transform=transforms)
    val_set = BackboneConformationDataset(config.dataset.val, transform=transforms)
